namespace Flee.Exceptions
{
    ...
    internal class ParserCreationException : Exception
	{
		...
		public ParserCreationException(ErrorType type, string info) : this(type, null, info)
		{
		}

		public ParserCreationException(ErrorType type, string name, string info) : this(type, name, info, null)
		{
		}
